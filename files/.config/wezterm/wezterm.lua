...
config.font = wezterm.font_with_fallback({
  ...
  { family = "Font Awesome 7 Free", weight = "Black" },   -- Solid (900)
  { family = "Font Awesome 7 Free", weight = "Regular" }, -- Regular (400)
  { family = "Font Awesome 7 Brands", weight = "Regular" },
})
...
config.font_rules = {
    ...
    font = wezterm.font_with_fallback({
      ...
      { family = "Font Awesome 7 Free", weight = "Black" },
      { family = "Font Awesome 7 Free", weight = "Regular" },
      { family = "Font Awesome 7 Brands", weight = "Regular" },
    }),
	},
	{
...
config.colors = {
	...
	background = "#CCCCCC", -- page: paper-white
...
config.window_padding = { left = 13, right = 0, top = 0, bottom = 0 }
