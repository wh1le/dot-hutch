...
# Overlay repositories for environment-specific configs (personal, work, etc.)
...
#
# This lets you keep public configs in one repo and layer personal/work-specific
...
mount_secrets_usb() {
  ...
  echo "Secrets unlocked at $SECRETS_MNT"
}
...
full-with-secrets)
  ...
  ;;
*)
  echo "Usage: $0 {disko|install|copy-secrets|generate-empty-sops|full|full-with-secrets} [hostname]"
  exit 1
  ;;
esac
