...
-- fzm font-size handler: responds to OSC 1337 user variable changes
-- Note: wezterm automatically decodes base64, so value is already plaintext
wezterm.on("user-var-changed", function(window, pane, name, value)
	if name == "FZM_FONT_SIZE" then
