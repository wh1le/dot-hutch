def apply_binds(c, config):
    ...
    config.bind('<z><l>', 'spawn --userscript qute-pass --unfiltered --username-target secret --username-pattern "login: (.+)" --dmenu-invocation "fzm --dmenu"')
    config.bind('<z><u>', 'spawn --userscript qute-pass --unfiltered --username-only --username-target secret --username-pattern "login: (.+)" --dmenu-invocation "fzm --dmenu"')
    config.bind('<z><p>', 'spawn --userscript qute-pass --unfiltered --password-only --dmenu-invocation "fzm --dmenu"')

    # TODO: Either change otp python userscript (avoidable) or update existing OTP entries to match notation
    # config.bind('<z><o>', 'spawn --userscript qute-pass --unfiltered --otp-only --dmenu-invocation $HOME/.local/bin/public/menu/launch-dmenu')
