...
Singleton {
    id: root
    property string filePath: Config.options.directories ? Config.options.directories.walColors : ""

    onFilePathChanged: if (filePath.length > 0) reapplyTheme()
