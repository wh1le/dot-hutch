...
QtObject {
    ...
    property color colSecondaryContainerHover: ColorUtils.mix(Appearance.colors.colLayer1Hover, root.color, 0.3)
    property color colSecondaryContainerActive: ColorUtils.mix(Appearance.colors.colLayer1Active, root.color, 0.5)
    property color colOnPrimary: ColorUtils.mix(Appearance.m3colors.m3onPrimary, root.color, 0.5)
