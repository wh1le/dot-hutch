...
set(0, "AerialNormal", { fg = black_color, bg = gray_color, link = white_color })
...
hl("DiagnosticSignError", { fg = gray95_color })
hl("DiagnosticSignWarn", { fg = gray95_color })
hl("DiagnosticSignInfo", { fg = gray95_color })
hl("DiagnosticSignHint", { fg = gray95_color })
