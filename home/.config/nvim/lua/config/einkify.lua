...
local function apply_eink()
	...
	-- vim.env.TERM = "tmux-256color" -- set by wezterm or tmux
	...
	hl("CurSearch", { bg = "gainsboro", fg = black_color, bold = true, nocombine = true })
	...
	vim.api.nvim_set_hl(0, "MsgArea", { fg = black_color, bg = white_color })

	-- optional: highlight spaces
	...
	vim.api.nvim_set_hl(0, "AerialCursorLine", { fg = black_color, bg = gray_color })
	...
	vim.api.nvim_set_hl(0, "Normal", { fg = 1, bg = "NONE" })
	vim.api.nvim_set_hl(0, "WildMenu", { fg = 0, bg = 7 })
	vim.api.nvim_set_hl(0, "PmenuSel", { fg = 6, bg = 8 })
end
