...
You can configure it post install and use this script to autogenerate a private/public key and empty config with default values ./scripts/deploy-empty-sops.sh
