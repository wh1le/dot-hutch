...

{
  ...
  services.tlp = {
    ...
    settings = {
      ...
      # Prevent CPU from sleeping too deep (reduces wake lag)
      CPU_MIN_PERF_ON_BAT = 10; # Min 10% performance on battery
      CPU_MAX_PERF_ON_BAT = 80; # Cap at 80% to save battery
