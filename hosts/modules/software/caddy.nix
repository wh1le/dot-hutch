{ ... }: {
  services.caddy = {
    enable = true;
    virtualHosts = {
      "searx.local".extraConfig = "reverse_proxy localhost:8882";
      "syncthing.local".extraConfig = "reverse_proxy localhost:8384";
      "printing.local".extraConfig = "reverse_proxy localhost:631";
